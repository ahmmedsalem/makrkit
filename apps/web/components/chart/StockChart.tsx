...
import { cn } from '~/lib/stocklib/utils';
    ...
    <div className="h-[27.5rem] w-full">
      <div>
        <div className="text-muted-foreground space-x-1">
          <span className="text-primary font-bold">{quoteData.symbol}</span>
          <span>·</span>
          <span>
        ...
        <div className="flex flex-row items-end justify-between">
          <div className="space-x-1">
            ...
            <span className="text-muted-foreground inline space-x-1 font-semibold">
